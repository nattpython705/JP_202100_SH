...
df_jp_ind = pd.read_csv('/Users/snatsuko/python/udemy/ana_JP_wage/csv_data/雇用_医療福祉_一人当たり賃金_全国_全産業.csv', encoding='shift_jis')
df_jp_category = pd.read_csv('/Users/snatsuko/python/udemy/ana_JP_wage/csv_data/雇用_医療福祉_一人当たり賃金_全国_大分類.csv', encoding='shift_jis')
df_pref_ind = pd.read_csv('/Users/snatsuko/python/udemy/ana_JP_wage/csv_data/雇用_医療福祉_一人当たり賃金_都道府県_全産業.csv', encoding='shift_jis')

st.header('■2019年：一人当たり平均賃金のヒートマップ')

jp_lat_lon = pd.read_csv('/Users/snatsuko/python/udemy/ana_JP_wage/pref_lat_lon.csv')
